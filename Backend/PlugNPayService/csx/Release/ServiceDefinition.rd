...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="PlugNPayService" generation="1" functional="0" release="0" Id="57f51ae6-aa0b-4dce-a459-889ea4a2f3f6" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="PlugNPayServiceGroup" generation="1" functional="0" release="0">
      <componentports>
        <inPort name="WorkerRole1:AsyncPos" protocol="tcp">
          <inToChannel>
            <lBChannelMoniker name="/PlugNPayService/PlugNPayServiceGroup/LB:WorkerRole1:AsyncPos" />
          </inToChannel>
        </inPort>
      ...
      <channels>
        <lBChannel name="LB:WorkerRole1:AsyncPos">
          <toPorts>
            <inPortMoniker name="/PlugNPayService/PlugNPayServiceGroup/WorkerRole1/AsyncPos" />
          </toPorts>
        </lBChannel>
      ...
      <components>
        <groupHascomponents>
          <role name="WorkerRole1" generation="1" functional="0" release="0" software="C:\Users\aidasa\Desktop\SkyDrive\Projects\PlugNPay\Backend\PlugNPayService\PlugNPayService\csx\Release\roles\WorkerRole1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
              <inPort name="AsyncPos" protocol="tcp" portRanges="2211" />
            ...
            <settings>
              ...
              <aCS name="__ModelData" defaultValue="&lt;m role=&quot;WorkerRole1&quot; xmlns=&quot;urn:azure:m:v1&quot;&gt;&lt;r name=&quot;WorkerRole1&quot;&gt;&lt;e name=&quot;AsyncPos&quot; /&gt;&lt;e name=&quot;Microsoft.WindowsAzure.Plugins.RemoteAccess.Rdp&quot; /&gt;&lt;e name=&quot;Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput&quot; /&gt;&lt;/r&gt;&lt;/m&gt;" />
            </settings>
            <resourcereferences>
  ...
  <implements>
    <implementation Id="db4eb6ba-87e0-4b32-92d2-3f04f1d48524" ref="Microsoft.RedDog.Contract\ServiceContract\PlugNPayServiceContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="36f92615-2773-4c9f-ba1f-78026dde0539" ref="Microsoft.RedDog.Contract\Interface\WorkerRole1:AsyncPos@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/PlugNPayService/PlugNPayServiceGroup/WorkerRole1:AsyncPos" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="84b198f3-2f61-4bf1-b510-644762611c38" ref="Microsoft.RedDog.Contract\Interface\WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/PlugNPayService/PlugNPayServiceGroup/WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
